...
import 'package:flutter_state_management_app/ui/widgets/drawer.item.widget.dart';
...
class MainDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<dynamic> menus=[
      ...
      {"title":"Counter Statful","route":"/counter1","leadingIcon":Icons.event,"trailingIcon":Icons.arrow_forward},
